  ...
  return (
    <SafeAreaView style={styles.root}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Field label={sl.products.name} value={data.name} />
        <Field label={sl.products.sku} value={data.sku} mono />
        <Field label={sl.products.description} value={data.description || '—'} />
        <Field label={sl.products.weight} value={`${data.weight} kg`} />
        <Field label={sl.products.category} value={categoryName} />

        <RoleGate feature="PRODUCTS_WRITE">
          <View style={styles.actionRow}>
            <TouchableOpacity
              style={styles.editBtn}
              onPress={() => router.push({ pathname: '/(tabs)/more/products/edit/[id]', params: { id: data.id } })}
            >
