...
export default function EditDriverScreen(): React.ReactElement {
  ...
  const mutation = useMutation({
    mutationFn: (values: DriverFormValues) => fleetApi.updateDriver(id!, values),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.drivers });
      queryClient.invalidateQueries({ queryKey: queryKeys.driverDetail(id!) });
      router.back();
    },
