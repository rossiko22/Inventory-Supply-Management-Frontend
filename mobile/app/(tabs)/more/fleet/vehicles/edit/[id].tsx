...
export default function EditVehicleScreen(): React.ReactElement {
  ...
  const mutation = useMutation({
    mutationFn: (values: VehicleFormValues) => fleetApi.updateVehicle(id!, values),
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: queryKeys.vehicles });
      queryClient.invalidateQueries({ queryKey: queryKeys.vehicleDetail(id!) });
      router.back();
    },
