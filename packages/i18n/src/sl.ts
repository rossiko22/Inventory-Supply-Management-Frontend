...
const sl = {
  ...
  auth: {
    ...
    // Web-only:
    appTitle:           'Sistem za upravljanje zalog',
  ...
  orders: {
    ...
    uploadAndClose: 'Naloži in zapri',
  ...
  products: {
    ...
    findBySku:   'Najdi po SKU',
    skuPlaceholder: 'Iskanje po SKU…',
    find:        'Najdi',
    clear:       'Počisti',
    match:       'Zadetek',
    noMatchSku:  'Ni produkta z SKU',
